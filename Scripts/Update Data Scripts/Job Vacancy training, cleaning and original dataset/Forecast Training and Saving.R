...
# Load data from file
# jobVacancy <- read.xlsx2(file="C:/Users/yiran/Google Drive/2018 S1/Cleaning Data/Material Data/VACANCY NEW 02.xlsx", sheetName = "Sheet1", header=TRUE)

jobVacancy <- read.csv(file="C:/Users/yiran/Google Drive/2018 S1/Cleaning Data/Material Data/VACANCY NEW AUST.csv",header=TRUE)

dim(jobVacancy)
View(jobVacancy)

#unique(jobVacancy$STATES)
...
write.csv(dfFore, file="C:/Users/yiran/Google Drive/2018 S1/Cleaning Data/Material Data/JOB VACANCY AUST FORECAST.csv")

# save historical dataframe and forecast dataframe into one file
# dfFinal <- rbind(dfFore, jobVacancy)
# 
# write.csv(dfFinal, file="C:/Users/yiran/Google Drive/2018 S1/Cleaning Data/Material Data/JOB VACANCY FINAL02.csv")
